...
#################################################
# file to edit: _notebooks/2021-01-18-spectral-norm.ipynb
-->
...
<figure>
    <img src="/images/copied_from_nb/data/spectral_norm/Group Training.png" height="500"/>
...
<h2 id="References">References<a class="anchor-link" href="#References"> </a></h2><p><!-- {% nocite OperatorNorm %}
{% nocite OrthoMatrices %} -->
